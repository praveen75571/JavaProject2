| No. | Job Name             | Reason for Deletion                          | Status     |
|-----|----------------------|----------------------------------------------|------------|
| 1   | `job-db_backup_2020` | Deprecated and replaced by new backup job    | ✅ Backed up |
| 2   | `job-test-legacy`    | No longer used; legacy test pipeline         | ✅ Backed up |
| 3   | `build-old-v1`       | Superseded by `build-v3`                     | ❌ Pending  |
